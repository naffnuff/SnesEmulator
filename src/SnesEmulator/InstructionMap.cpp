...
{
    instructions[0x61] = std::make_unique<ADC_61>("ADC (dp,X)", "Direct Page Indexed Indirect,X");
    ...
    instructions[0x67] = std::make_unique<ADC_67>("ADC [dp]", "Direct Page Indirect Long");
    ...
    instructions[0x71] = std::make_unique<ADC_71>("ADC (dp),Y", "Direct Page Indirect Indexed, Y");
    instructions[0x72] = std::make_unique<ADC_72>("ADC (dp)", "Direct Page Indirect");
    instructions[0x73] = std::make_unique<ADC_73>("ADC (sr,S),Y", "Stack Relative Indirect Indexed,Y");
    instructions[0x75] = std::make_unique<ADC_75>("ADC dp,X", "Direct Page Indexed,X");
    instructions[0x77] = std::make_unique<ADC_77>("ADC [dp],Y", "Direct Page Indirect Long Indexed, Y");
    ...
    instructions[0x21] = std::make_unique<AND_21>("AND (dp,X)", "Direct Page Indexed Indirect,X");
    ...
    instructions[0x27] = std::make_unique<AND_27>("AND [dp]", "Direct Page Indirect Long");
    ...
    instructions[0x31] = std::make_unique<AND_31>("AND (dp),Y", "Direct Page Indirect Indexed, Y");
    instructions[0x32] = std::make_unique<AND_32>("AND (dp)", "Direct Page Indirect");
    instructions[0x33] = std::make_unique<AND_33>("AND (sr,S),Y", "Stack Relative Indirect Indexed,Y");
    instructions[0x35] = std::make_unique<AND_35>("AND dp,X", "Direct Page Indexed,X");
    instructions[0x37] = std::make_unique<AND_37>("AND [dp],Y", "Direct Page Indirect Long Indexed, Y");
    ...
    instructions[0x16] = std::make_unique<ASL_16>("ASL dp,X", "Direct Page Indexed,X");
    ...
    instructions[0x34] = std::make_unique<BIT_34>("BIT dp,X", "Direct Page Indexed,X");
    ...
    instructions[0xC1] = std::make_unique<CMP_C1>("CMP (dp,X)", "Direct Page Indexed Indirect,X");
    ...
    instructions[0xC7] = std::make_unique<CMP_C7>("CMP [dp]", "Direct Page Indirect Long");
    ...
    instructions[0xD1] = std::make_unique<CMP_D1>("CMP (dp),Y", "Direct Page Indirect Indexed, Y");
    instructions[0xD2] = std::make_unique<CMP_D2>("CMP (dp)", "Direct Page Indirect");
    instructions[0xD3] = std::make_unique<CMP_D3>("CMP (sr,S),Y", "Stack Relative Indirect Indexed,Y");
    instructions[0xD5] = std::make_unique<CMP_D5>("CMP dp,X", "Direct Page Indexed,X");
    instructions[0xD7] = std::make_unique<CMP_D7>("CMP [dp],Y", "Direct Page Indirect Long Indexed, Y");
    ...
    instructions[0xD6] = std::make_unique<DEC_D6>("DEC dp,X", "Direct Page Indexed,X");
    ...
    instructions[0x41] = std::make_unique<EOR_41>("EOR (dp,X)", "Direct Page Indexed Indirect,X");
    ...
    instructions[0x47] = std::make_unique<EOR_47>("EOR [dp]", "Direct Page Indirect Long");
    ...
    instructions[0x51] = std::make_unique<EOR_51>("EOR (dp),Y", "Direct Page Indirect Indexed, Y");
    instructions[0x52] = std::make_unique<EOR_52>("EOR (dp)", "Direct Page Indirect");
    instructions[0x53] = std::make_unique<EOR_53>("EOR (sr,S),Y", "Stack Relative Indirect Indexed,Y");
    instructions[0x55] = std::make_unique<EOR_55>("EOR dp,X", "Direct Page Indexed,X");
    instructions[0x57] = std::make_unique<EOR_57>("EOR [dp],Y", "Direct Page Indirect Long Indexed, Y");
    ...
    instructions[0xF6] = std::make_unique<INC_F6>("INC dp,X", "Direct Page Indexed,X");
    ...
    instructions[0xA1] = std::make_unique<LDA_A1>("LDA (dp,X)", "Direct Page Indexed Indirect,X");
    ...
    instructions[0xA7] = std::make_unique<LDA_A7>("LDA [dp]", "Direct Page Indirect Long");
    ...
    instructions[0xB1] = std::make_unique<LDA_B1>("LDA (dp),Y", "Direct Page Indirect Indexed, Y");
    instructions[0xB2] = std::make_unique<LDA_B2>("LDA (dp)", "Direct Page Indirect");
    instructions[0xB3] = std::make_unique<LDA_B3>("LDA (sr,S),Y", "Stack Relative Indirect Indexed,Y");
    instructions[0xB5] = std::make_unique<LDA_B5>("LDA dp,X", "Direct Page Indexed,X");
    instructions[0xB7] = std::make_unique<LDA_B7>("LDA [dp],Y", "Direct Page Indirect Long Indexed, Y");
    ...
    instructions[0xB6] = std::make_unique<LDX_B6>("LDX dp,Y", "Direct Page Indexed,Y");
    ...
    instructions[0xB4] = std::make_unique<LDY_B4>("LDY dp,X", "Direct Page Indexed,X");
    ...
    instructions[0x56] = std::make_unique<LSR_56>("LSR dp,X", "Direct Page Indexed,X");
    ...
    instructions[0x01] = std::make_unique<ORA_01>("ORA (dp,X)", "Direct Page Indexed Indirect,X");
    ...
    instructions[0x07] = std::make_unique<ORA_07>("ORA [dp]", "Direct Page Indirect Long");
    ...
    instructions[0x11] = std::make_unique<ORA_11>("ORA (dp),Y", "Direct Page Indirect Indexed, Y");
    instructions[0x12] = std::make_unique<ORA_12>("ORA (dp)", "Direct Page Indirect");
    instructions[0x13] = std::make_unique<ORA_13>("ORA (sr,S),Y", "Stack Relative Indirect Indexed,Y");
    instructions[0x15] = std::make_unique<ORA_15>("ORA dp,X", "Direct Page Indexed,X");
    instructions[0x17] = std::make_unique<ORA_17>("ORA [dp],Y", "Direct Page Indirect Long Indexed, Y");
    ...
    instructions[0xD4] = std::make_unique<PEI_D4>("PEI (dp)", "Stack (Direct Page Indirect)");
    instructions[0x62] = std::make_unique<PER_62>("PER label", "Stack (Program Counter Relative Long)");
    ...
    instructions[0x36] = std::make_unique<ROL_36>("ROL dp,X", "Direct Page Indexed,X");
    ...
    instructions[0x76] = std::make_unique<ROR_76>("ROR dp,X", "Direct Page Indexed,X");
    ...
    instructions[0xE1] = std::make_unique<SBC_E1>("SBC (dp,X)", "Direct Page Indexed Indirect,X");
    ...
    instructions[0xE7] = std::make_unique<SBC_E7>("SBC [dp]", "Direct Page Indirect Long");
    ...
    instructions[0xF1] = std::make_unique<SBC_F1>("SBC (dp),Y", "Direct Page Indirect Indexed, Y");
    instructions[0xF2] = std::make_unique<SBC_F2>("SBC (dp)", "Direct Page Indirect");
    instructions[0xF3] = std::make_unique<SBC_F3>("SBC (sr,S),Y", "Stack Relative Indirect Indexed,Y");
    instructions[0xF5] = std::make_unique<SBC_F5>("SBC dp,X", "Direct Page Indexed,X");
    instructions[0xF7] = std::make_unique<SBC_F7>("SBC [dp],Y", "Direct Page Indirect Long Indexed, Y");
    ...
    instructions[0xE2] = std::make_unique<SEP_E2>("SEP #const", "Immediate");
    instructions[0x81] = std::make_unique<STA_81>("STA (dp,X)", "Direct Page Indexed Indirect,X");
    ...
    instructions[0x87] = std::make_unique<STA_87>("STA [dp]", "Direct Page Indirect Long");
    ...
    instructions[0x91] = std::make_unique<STA_91>("STA (dp),Y", "Direct Page Indirect Indexed, Y");
    instructions[0x92] = std::make_unique<STA_92>("STA (dp)", "Direct Page Indirect");
    instructions[0x93] = std::make_unique<STA_93>("STA (sr,S),Y", "Stack Relative Indirect Indexed,Y");
    instructions[0x95] = std::make_unique<STA_95>("STA dp,X", "Direct Page Indexed,X");
    instructions[0x97] = std::make_unique<STA_97>("STA [dp],Y", "Direct Page Indirect Long Indexed, Y");
    ...
    instructions[0x96] = std::make_unique<STX_96>("STX dp,Y", "Direct Page Indexed,Y");
    instructions[0x84] = std::make_unique<STY_84>("STY dp", "Direct Page");
    instructions[0x8C] = std::make_unique<STY_8C>("STY addr", "Absolute");
    instructions[0x94] = std::make_unique<STY_94>("STY dp,X", "Direct Page Indexed,X");
    instructions[0x64] = std::make_unique<STZ_64>("STZ dp", "Direct Page");
    instructions[0x74] = std::make_unique<STZ_74>("STZ dp,X", "Direct Page Indexed,X");
